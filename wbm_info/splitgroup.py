...
dic=getgroupdic('rates_MC_v4p4_V1__frozen_2015_25ns14e33_v4p4_HLT_V1_2e33_PUfilterGen_EMEn_MuEn_matrixRates.tsv')
for group in dic:
    printgrouprates(dic[group],'256843/258287HLT.csv','Results/group',group)
